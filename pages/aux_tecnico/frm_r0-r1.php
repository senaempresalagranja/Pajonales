...
<div class="my-container">
    ...
    <div id="pagina_completa">
        ...
        <div class="bg-white-primary" id="Innovacion">
            <div class="container">
                <form action="reg/reg_6.php" id="formulario" method="post">                    
                    <div row="row">
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" name="fechainicioPrimordio_ps" class="form-control" id="fechainicioPrimordio_ps" required/>
                            </div>
                        </div>
                    </div>
<!-- ---------------------------------------------------------- -->
