...
INNER JOIN tipo_cultivo ON tipo_cultivo.Idtipo_cultivo = cultivo.Idtipo_cultivo 
  WHERE fecha_ps LIKE '%$fecha_ps%'

AND lote.NumeroLote LIKE '%$NumeroLote%'

AND cultivo.NombreCultivo LIKE '%$NombreCultivo%'
...
<td class='col-xs-2'><?php echo $fila[11] ?></td>
                          ...
                          <td class='col-xs-1'>
                           <form style='float:left' action='most/Mostrar_Preparacion_Suelo.php' method='post'>  
