...
$fechafloracion_ps=$_POST["fechafloracion_ps"];
...
INNER JOIN tipo_cultivo ON tipo_cultivo.Idtipo_cultivo = cultivo.Idtipo_cultivo 
  WHERE fechafloracion_ps LIKE '%$fechafloracion_ps%'
...
<td class='col-xs-2'><?php echo $fila[9] ?></td>
                          ...
                          <td class='col-xs-1'>
                           <form style='float:left' action='most/Mostrar_r2-r3.php' method='post'>  
