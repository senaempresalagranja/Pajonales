...
$fechainicioPrimordio_ps=$_POST["fechainicioPrimordio_ps"];
...
INNER JOIN tipo_cultivo ON tipo_cultivo.Idtipo_cultivo = cultivo.Idtipo_cultivo 
  WHERE fechainicioPrimordio_ps LIKE '%$fechainicioPrimordio_ps%'
...
<td class='col-xs-2'><?php echo $fila[9] ?></td>
                          ...
                          <td class='col-xs-1'>
                           <form style='float:left' action='most/Mostrar_r0-r1.php' method='post'>  
