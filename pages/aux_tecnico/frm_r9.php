...
<div class="my-container">
    ...
    <div id="pagina_completa">
        ...
        <div class="bg-white-primary" id="Innovacion">
            <div class="container">
                <form action="reg/reg_10.php" method="post">
                    <div row="row">
                        <div class="col-md-4">
...
<!-- ---------------------------------------------------------- -->
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <label for="numGranosPanicula_ps">Número de granos/panicula:</label>
                                <input type="text" name="numGranosPanicula_ps" class="form-control" id="numGranosPanicula_ps" required/>
                                <label style="font-style: italic;">>=70</label>
                        </div>
                        <div class="col-md-4">
                            <label for="peso_ps">Peso 1000 granos:</label>
                                <input type="text" name="peso_ps" class="form-control" id="peso_ps" required/>
                                <label style="font-style: italic;">De 27 a 35g</label>
                        </div>
                        <div class="col-md-4">
                            <label for="vaneamiento_ps">% vaneamiento:</label>
                                <input type="text" name="vaneamiento_ps" class="form-control" id="vaneamiento_ps" required/>
                                <label style="font-style: italic;"><=35%</label>
                        </div>
                    </div>
<!-- ---------------------------------------------------------- -->
