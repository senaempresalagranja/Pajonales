                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" name="fechaemergencia_ps" class="form-control" id="fechaemergencia_ps" required/>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="germinacionsemilla_ps">% de Germinación de Semilla:</label>
                                <input type="text" name="germinacionsemilla_ps" class="form-control" id="germinacionsemilla_ps" required/>
                                <label style="font-style: italic;">>= 60% (Numérico)</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="plantasemergidas_ps">Plantas Emergidas /m²:</label>
                                <input type="text" name="plantasemergidas_ps" class="form-control" id="plantasemergidas_ps" required/>
                                <label style="font-style: italic;">>= 250(Numérico)</label>
