...
<div class="my-container">
    ...
    <div id="pagina_completa">
        <div class="bg-white-primary" id="Innovacion">
            <div class="container">
                <form action="reg/reg_4.php" method="post">
                    <!-- <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <h2 class="text-center">V3 - V5</h2>
                        </div>
                    </div> -->
                    <div row="row">
                        <div class="col-md-4">
...
<!-- ---------------------------------------------------------- -->
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="fechainiciomacollamiento_ps">Inicio de macollamiento:</label>
                                <input type="date" name="fechainiciomacollamiento_ps" class="form-control" id="fechainiciomacollamiento_ps" required/>
                            </div>
                        </div>
                    </div>
<!-- ---------------------------------------------------------- -->
