...
<div class="my-container">
    <h1>PREPARACION DEL SUELO</h1>
</div>
    <div id="pagina_completa">

        <div class="bg-white-primary" id="Innovacion">
            <div class="container">
                <form action="reg/reg_1.php" id="formulario" method="post">
                    <div row="row">
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="latitud_ps" class="form-control" id="latitud_ps" maxlength="30" onkeypress="return Coorla(event);" onkeyup="Orilatitud(this);" required/>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="longitud_ps" class="form-control" id="longitud_ps" maxlength="30" onkeypress="return Coorlo(event);" onkeyup="Orilongitud(this);" required/>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
...
<!-- ---------------------------------------------------------- -->
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="profundidadpreparacion_ps">Profundidad de la preparación:</label>
                                <input type="text" name="profundidadpreparacion_ps" class="form-control" id="profundidadpreparacion_ps" onkeypress='return soloNumeros(event)' required/>
                                <label style="font-style: italic;font-weight: normal;color: #009b55;"font-weight: normal; color: #009b55">=7 cm (Numérico)</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="tamanoterrones_ps">Tamaño de Terrones:</label>
                                <input type="text" name="tamanoterrones_ps" class="form-control" id="tamanoterrones_ps" onkeypress='return soloNumeros(event)' required/>
                                <label style="font-style: italic;font-weight: normal;color: #009b55;"><=20 cm (Numérico)</label>
                            </div>
                        </div>
                    </div>
<!-- ---------------------------------------------------------- -->
