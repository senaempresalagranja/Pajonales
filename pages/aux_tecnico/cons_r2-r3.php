                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="fechafloracion_ps">Fecha inicio de Floración: </label>
                                <input type="date" class="form-control" id="fechafloracion_ps">
                      ...
                      <table class="table table-bordered table-striped table ">
                        <thead>
                          <tr>
                            ...
                            <th> Cultivo </th>
                            <th> Tipo Cultivo  </th>
                            <th> Fecha inicio de Floración:</th>
                            <th></th>
                          </tr>
                        </thead>
...
function inicio() {
    ...
    $("#fechafloracion_ps").keyup(enviar);
...
function validar_fechafloracion_ps() {
  
  var fechafloracion_ps=document.getElementById("fechafloracion_ps").value;
  var fechafloracion_ps=new Date(fechafloracion_ps);
  if (fechafloracion_ps=="Invalid Date") {
    var fechafloracion_ps=document.getElementById("fechafloracion_ps").style.border="1px solid red";
    return false;
  }else{

    var fechafloracion_ps=document.getElementById("fechafloracion_ps").style.border="1px solid green";
    return true;
  }
}
...
function enviar() {
    if (validar_fechafloracion_ps() == true || validar_NumeroLote() == true) {
        var fechafloracion_ps = document.getElementById('fechafloracion_ps').value;
        var NumeroLote = document.getElementById('NumeroLote').value;
   
        $("#contenedor").load("cons/Most-r2-r3.php", {

            fechafloracion_ps: fechafloracion_ps,
