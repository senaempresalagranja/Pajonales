...
<!-- ---------------------------------------------------------- -->
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="fechaemergencia_ps">Macollas Efectivas/m²:</label>
                                <p><?php echo $fila[9] ?></p>
                                <label style="font-size: 12px; font-style: italic;font-weight: normal;color: #009b55;">>=260</label>
                            </div>
                        </div>
                    </div>
<!-- ---------------------------------------------------------- -->
