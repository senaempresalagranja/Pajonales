...
<!-- ---------------------------------------------------------- -->
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="fechaemergencia_ps">Fecha inicio de Floración:</label>
                                <p><?php echo $fila[9] ?></p>
