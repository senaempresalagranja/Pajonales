...
<!-- ---------------------------------------------------------- -->
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="fechaemergencia_ps">Macollas/m²:</label>
                                <p><?php echo $fila[9] ?></p>
