                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <p><?php echo $fila[9] ?></p>
                                <label style="font-size: 12px; font-style: italic;font-weight: normal;color: #009b55;"font-weight: normal; color: #009b55">=7 cm (Numérico)</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <label style="font-size: 12px; font-style: italic;font-weight: normal;color: #009b55;"><=20 cm (Numérico)</label>
                            </div>
                        </div>
                    </div>
<!-- ---------------------------------------------------------- -->
