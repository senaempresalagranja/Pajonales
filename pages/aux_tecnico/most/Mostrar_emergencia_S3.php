                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <label style="font-size: 12px; font-style: italic;font-weight: normal;color: #009b55;">>= 60% (Numérico)</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <label style="font-size: 12px; font-style: italic;font-weight: normal;color: #009b55;">>= 250(Numérico)</label>
