...
<!-- ---------------------------------------------------------- -->
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="fechaemergencia_ps">Número de granos/panicula::</label>
                                <p><?php echo $fila[9] ?></p>
                                <label style="font-size: 12px; font-style: italic;font-weight: normal;color: #009b55;">>=70</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="germinacionsemilla_ps">Peso 1000 granos:</label>
                                <p><?php echo $fila[10] ?></p>
                                <label style="font-size: 12px; font-style: italic;font-weight: normal;color: #009b55;">De 27 a 35g</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="plantasemergidas_ps">% vaneamiento:</label>
                                <p><?php echo $fila[11] ?></p>
                                <label style="font-size: 12px; font-style: italic;font-weight: normal;color: #009b55;"><=35%</label>
