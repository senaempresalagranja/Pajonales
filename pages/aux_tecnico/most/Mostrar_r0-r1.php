...
<!-- ---------------------------------------------------------- -->
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="fechaemergencia_ps">Fecha inicio de Primordio floral:</label>
                                <p><?php echo $fila[9] ?></p>
                                <!-- <label style="font-size: 12px; font-style: italic;font-weight: normal;color: #009b55;">Est. Crec R0 ==>300 a 500 macollas</label> -->
                            </div>
                        </div>
                    </div>
<!-- ---------------------------------------------------------- -->
