...
{ 
  ...
  <head>
   ...
   <script src="https://cdn.rawgit.com/openlayers/openlayers.github.io/master/en/v5.3.0/css/ol.js"></script>
      ...
      <ul class="sidebar-menu"> <!-- colorcar la clase "active" cuando sea necesario --> 
        ...
        <li class="treeview"><a href="#"><i class="fa fa-share"></i><span>Registrar</span><i class="fa fa-angle-right"></i></a>
          <ul class="treeview-menu">                
            <li class="treeview">
              <a href="../frm_cultivo.php"><i class="fa fa-"></i><span>Cultivo</span></a>
            </li>
            <li class="treeview">
